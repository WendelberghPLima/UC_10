...
namespace Uc_10_Wendel_Relacionamentos_Descricao_00004.Controllers
{
    public class AutomovelsController : Controller
    {
        private readonly Uc_10_Wendel_Relacionamentos_Descricao_00004Context _context;

        public AutomovelsController(Uc_10_Wendel_Relacionamentos_Descricao_00004Context context)
        {
            _context = context;
        }
        ...
        {
            var uc_10_Wendel_Relacionamentos_Descricao_00004Context = _context.Automovel.Include(a => a.Marca);
            return View(await uc_10_Wendel_Relacionamentos_Descricao_00004Context.ToListAsync());
        }
