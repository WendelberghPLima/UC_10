...
namespace Uc_10_Wendel_Relacionamentos_Descricao__00500.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public PacientesController(Uc_10_Wendel_Relacionamentos_Descricao__00500Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,Nome,Idade,Telefone")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,Nome,Idade,Telefone")] Paciente paciente)
        {
